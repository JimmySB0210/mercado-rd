...
export const products = {
  ...
  vendorMemberSince: "Vendeur depuis {date}",
  shippingToProvinceLabel: "🚚 Livraison : {amount} vers votre province",
  shippingFreeToProvinceLabel: "🚚 Livraison gratuite vers votre province",
  shippingCoverageLine: "Nous livrons dans les 32 provinces de la RD",
  trustVerifiedVendor: "Vendeur vérifié",
  trustSecurePayment: "Paiement sécurisé",
  trustOrderTracking: "Suivi de commande",
  trustPlatformSupport: "Support MercadoRD",
  tabShipping: "Livraison",
  tabFaqLabel: "Questions",
