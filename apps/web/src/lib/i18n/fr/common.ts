...
export const common = {
  ...
  // ── Colonne "À propos" (acerca-de) ──
  footerSectionAbout: "À propos",
  footerAboutUs: "À propos de nous",
  footerCommitment: "Notre engagement",
  footerWhyChooseUs: "Pourquoi nous choisir",
  footerResponsibility: "Responsabilité",
