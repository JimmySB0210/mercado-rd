...
export const profile = {
  ...
  giftListsPageTitle: 'My gift list',
  giftListsIntro: 'Create your list, share it, and let others give you exactly what you want.',
  aliasLabel: "Your alias (doesn't have to be your real name)",
  aliasPlaceholder: "E.g. Jimmy's list",
  deliveryAddressLabel: 'Delivery address',
  deliveryAddressPlaceholder: 'Street, number, sector, reference...',
  deliveryAddressHint: 'Never shown publicly — only used to deliver the gifts.',
  selectProvincePlaceholder: 'Select your province',
  createListButton: 'Create my gift list',
  creatingButton: 'Creating...',
  createListError: "We couldn't create your list. Please try again.",
  ...
  noSearchResults: "We couldn't find any products with that name.",
  addProductButton: '+ Add',
  addedProductButton: '✓ Added',
  myGiftItemsTitle: 'Products on your list',
  emptyGiftItemsMessage: "You haven't added any products to your gift list yet.",
  emptyGiftItemsHint: 'Search above or use "Add to my gift list" from any product.',
  removeItemButton: 'Remove',
  giftedItemBadge: '🎁 Already gifted',
