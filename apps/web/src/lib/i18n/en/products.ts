...
export const products = {
  ...
  vendorMemberSince: "Seller since {date}",
  shippingToProvinceLabel: "🚚 Shipping: {amount} to your province",
  shippingFreeToProvinceLabel: "🚚 Free shipping to your province",
  shippingCoverageLine: "We ship to all 32 provinces of the DR",
  trustVerifiedVendor: "Verified seller",
  trustSecurePayment: "Secure payment",
  trustOrderTracking: "Order tracking",
  trustPlatformSupport: "MercadoRD support",
