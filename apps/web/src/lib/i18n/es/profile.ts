...
export const profile = {
  ...
  // app/perfil/lista-regalos/page.tsx
  giftListsPageTitle: 'Mi lista de regalos',
  giftListsIntro: 'Crea tu lista, compártela y deja que otros te regalen justo lo que quieres.',
  aliasLabel: 'Tu alias (no tiene que ser tu nombre real)',
  aliasPlaceholder: 'Ej. La lista de Jimmy',
  deliveryAddressLabel: 'Dirección de entrega',
  deliveryAddressPlaceholder: 'Calle, número, sector, referencia...',
  deliveryAddressHint: 'Nunca se muestra públicamente — solo se usa para entregar los regalos.',
  selectProvincePlaceholder: 'Selecciona tu provincia',
  createListButton: 'Crear mi lista de regalos',
  creatingButton: 'Creando...',
  createListError: 'No se pudo crear tu lista. Intenta de nuevo.',
  shareLinkLabel: 'Tu enlace para compartir',
  copyLinkButton: 'Copiar enlace',
  linkCopiedButton: '¡Copiado! ✓',
  searchProductsPlaceholder: 'Buscar productos para agregar...',
  searchButton: 'Buscar',
  searchingButton: 'Buscando...',
  noSearchResults: 'No encontramos productos con ese nombre.',
  addProductButton: '+ Agregar',
  addedProductButton: '✓ Agregado',
  myGiftItemsTitle: 'Productos en tu lista',
  emptyGiftItemsMessage: 'Aún no has agregado productos a tu lista de regalos.',
  emptyGiftItemsHint: 'Búscalos arriba o usa "Agregar a mi lista de regalos" desde cualquier producto.',
  removeItemButton: 'Quitar',
  giftedItemBadge: '🎁 Ya fue regalado',
  priorityHighOption: 'Alta',
  priorityMediumOption: 'Media',
